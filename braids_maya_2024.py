...
def incident_edges(vtx_str):
    ...
    semicol_loc = polyInfo_ret_strs[0].find( ":")
...
def export_uniquimerxml(filepath, scale=7):
    ...
    for fiveprimeend in fiveprimeends:
        ...
        #base_type = fiveprimeend[(fiveprimeend.find( "|") + 1):]
...
def facial_cycle_render():
    ...
    for eid in range(0, num_edges):
        ...
        neigh_endpts_str = polyInfo_ret_strs[0][polyInfo_ret_strs[0].find( ":")+1:len(polyInfo_ret_strs[0])]
        ...
        polyInfo_ret_strs = cmds.polyInfo(edgeToVertex=True)
        debugprint(polyInfo_ret_strs)
        otherneigh_endpts_str = polyInfo_ret_strs[0][polyInfo_ret_strs[0].find( ":")+1:len(polyInfo_ret_strs[0])]
